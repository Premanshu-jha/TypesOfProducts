...
public class ProductController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<ProductDto>> getProductByKeyword(@RequestParam(value="keyword",required=false) String keyword,@RequestParam(value="minPrice",required=false) Double minPrice,@RequestParam(value="maxPrice",required=false) Double maxPrice){
        Specification<Product> spec = Specification.where(null);
        if(keyword != null) spec = spec.and(ProductSpecification.nameContains(keyword));
        if(minPrice != null) spec = spec.and(ProductSpecification.priceGreaterThanOrEqualTo(minPrice));
        if(maxPrice != null) spec = spec.and(ProductSpecification.priceLessThanOrEqualTo(maxPrice));
    ...
    public ResponseEntity<ProductDto> postProduct(@RequestBody Product product){
        if(product.getCategory()!=null) {
            ...
            product.setCreatedDate(LocalDateTime.now());  // Only set on creation
